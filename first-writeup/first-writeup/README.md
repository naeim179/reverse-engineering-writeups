...
identifying the .NET nature of the binary,

extracting the embedded encrypted resource,

reversing the decryption logic,

fixing the resulting file format,

and finally reading the flag from the recovered image.
